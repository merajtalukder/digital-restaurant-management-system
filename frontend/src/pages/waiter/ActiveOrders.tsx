            ...
            return (
              ...
              >
                ...
                <div className="mt-4 border-t border-slate-100 bg-slate-50/70 p-4">
                  ...
                  {!isPaid && (
                    <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                      ...
                      <button
                        onClick={() =>
                          navigate(
                            `/waiter/payment/${order.id}`
                          )
                        }
                        className="flex w-full items-center justify-center gap-2 rounded-xl bg-orange-500 px-4 py-3 text-sm font-bold text-white shadow-md shadow-orange-200/50 transition-all duration-200 hover:bg-orange-600 hover:shadow-lg active:scale-[0.98]"
                      >
                        <CreditCard size={18} />
                        Payment
                      </button>
                  ...
                  {/* Paid Order */}
                  {isPaid && (
                    <div className="flex items-center justify-center gap-2 rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm font-bold text-emerald-600">
                      <CreditCard size={17} />
                      Payment Completed
                    </div>
                  )}
