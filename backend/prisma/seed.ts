  ...
  const categories = [
    {
      name: "Burgers",
      description:
        "Freshly prepared burgers with chicken, beef and cheese.",
    },
    {
      name: "Pizza",
      description:
        "Freshly baked pizzas with delicious toppings.",
    },
    {
      name: "Rice & Biryani",
      description:
        "Traditional rice dishes and flavorful biryani.",
    },
    {
      name: "Chicken & Grill",
      description:
        "Grilled, fried and spicy chicken dishes.",
    },
    {
      name: "Pasta & Noodles",
      description:
        "Creamy pasta, spaghetti and Asian-style noodles.",
    },
    {
      name: "Snacks & Appetizers",
      description:
        "Crispy snacks, fries and delicious appetizers.",
    },
    {
      name: "Drinks",
      description:
        "Soft drinks, juices, coffee, shakes and refreshing beverages.",
    },
    {
      name: "Desserts",
      description:
        "Cakes, ice cream, brownies and sweet treats.",
    },
  ];
